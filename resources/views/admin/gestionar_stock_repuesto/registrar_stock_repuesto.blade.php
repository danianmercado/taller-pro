...
@section('contenido')
    <div class="row">
        <div class="col s12 m10 offset-m1 l6 offset-l3">
            ...
            <form action="{{route('admin.stock_repuesto.guardar')}}" method="POST">
                @csrf
                <div class="card z-depth-4">
                    <div class="card-content">


                        <span class="card-title center-align">Registrar stock de repuesto</span>
                        <div class="row">
                            <div class="col s12 input-field">
                                <select name="id_insumo">
                                    <option value="" disabled selected>Seleccione el repuesto:</option>
